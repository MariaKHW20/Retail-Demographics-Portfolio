This project investigates key business questions around customer behaviour, demographic patterns and revenue drivers within a 2023 retail customer and sales dataset from Kaggle. To support the visualisations built in Tableau, I developed a series of SQL queries that aggregated the data to reveal meaningful trends. The examples below highlight how SQL was used to generate insights and how these outputs directly informed the dashboards.
...
- The significant drop in July indicates a lack of customer engagement and promotional activity. Reduced traffic and fewer repeat purchases are likely to be caused by a combination of there being a seasonal slowdown and weak retention strategies. 
